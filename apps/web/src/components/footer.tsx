export function Footer() {
  return (
    <footer className="py-8 text-center bg-krem">
      <div className="flex justify-center gap-4 mb-4 flex-wrap">
        <a
          href="https://wa.me/628112049902"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 rounded-full border-2 border-gray-300 bg-white px-6 py-3 text-sm font-semibold text-hijau-tua transition hover:border-hijau-sedang hover:shadow-md"
        >
        ...
        <a
          href="https://instagram.com/kkmht25"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 rounded-full border-2 border-gray-300 bg-white px-6 py-3 text-sm font-semibold text-hijau-tua transition hover:border-hijau-sedang hover:shadow-md"
        >
